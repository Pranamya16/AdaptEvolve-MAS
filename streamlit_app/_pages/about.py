...
def render() -> None:
    st.title("About AdaptiWolf")

    st.markdown("""
## AdaptiWolf: Adaptive Meta-Evolutionary Multi-Agent Code Optimization

AdaptiWolf is a research framework developed at **GESCOEMSR, Nashik** that addresses a fundamental
...
Like a wolf pack that restructures its hunting strategy based on terrain, AdaptiWolf uses four
...
AdaptiWolf is designed with four verifiable safety properties:
